...
const MainNavBar: React.FC = () => {
    ...
    const svgSize = windowSize.width > 900 ? windowSize.width * 0.03 : windowSize.width * 0.08
    const logoSize = windowSize.width > 900 ? windowSize.width * 0.01 : windowSize.width * 0.02
